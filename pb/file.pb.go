...
func (x *DownloadResponse) GetDate() []byte {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *UploadRequest) GetDate() []byte {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *UploadAndNotifyProgressRequest) GetDate() []byte {
	if x != nil {
		return x.Date
	}
	return nil
...
type UploadAndNotifyProgressReaponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UploadAndNotifyProgressReaponse) Reset() {
	*x = UploadAndNotifyProgressReaponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UploadAndNotifyProgressReaponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UploadAndNotifyProgressReaponse) ProtoMessage() {}

func (x *UploadAndNotifyProgressReaponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_file_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UploadAndNotifyProgressReaponse.ProtoReflect.Descriptor instead.
func (*UploadAndNotifyProgressReaponse) Descriptor() ([]byte, []int) {
	return file_proto_file_proto_rawDescGZIP(), []int{7}
}

func (x *UploadAndNotifyProgressReaponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x22, 0x23, 0x0a, 0x0d, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x22, 0x24, 0x0a, 0x0e, 0x55,
	...
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x22, 0x33, 0x0a, 0x1f, 0x55, 0x70, 0x6c, 0x6f, 0x61,
	0x64, 0x41, 0x6e, 0x64, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x52, 0x65, 0x61, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73,
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0xab, 0x02, 0x0a,
	0x0b, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x09,
	...
	0x61, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f,
...
var file_proto_file_proto_goTypes = []interface{}{
	...
	(*UploadAndNotifyProgressReaponse)(nil), // 7: file.UploadAndNotifyProgressReaponse
}
var file_proto_file_proto_depIdxs = []int32{
	...
	7, // 7: file.Fileservice.UploadAndNotifyProgress:output_type -> file.UploadAndNotifyProgressReaponse
...
func file_proto_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_file_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UploadAndNotifyProgressReaponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
